export default {
    ...
    // premiumAppIntegrationTypeId: 'smoketest-product-combination-integration-type',
    ...
    // Enable the optional Post Custom Setup module in the installation process
    ...
    // Enable the dynamic build of the Installation Summary on install.html page
    ...
    provisioningInfo: {
        ...
        'group': [
            {
                'name': 'ELM',
                'description': 'Enhanced List Manager group.',
            }
        ],
        'app-instance': [
            {
                'name': 'Enhanced List Manager',
        ...
        'oauth-client': [
            {
                'name': 'ELM OAuth Client',
                'description': 'Generated Client that\'s passed to the ELM App Backend',
                'roles': ['ELM Role'],
